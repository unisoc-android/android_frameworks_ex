...
public class SprdCameraCapabilities {
    ...
    protected Range<Long> mExposureTimeRange;
    protected final ArrayList<Long>  mExposureTimeList= new ArrayList<Long>();
    protected Float mMinFocusDistance;//LENS_INFO_MINIMUM_FOCUS_DISTANCE
    ...
    public Float getFocusDistanceScale() {
        return mMinFocusDistance;
    }

    public ArrayList<Long> getSupportedExposureTimeList() {
        return mExposureTimeList;
    }
    ...
    public int mSupportFlashLevel = 0;
    public int mSupportAutoHdr = 0;
    public int mSupportAuto3Dnr = 0;
    public final boolean supportAdjustFlashLevel(){
        return (mSupportFlashLevel != 0);
    }
    public final int getSupportedFlashLevel(){
        return mSupportFlashLevel;
    }
    public final boolean supportAutoHdr(){return mSupportAutoHdr != 0;}
    public final boolean supportAuto3Dnr(){return mSupportAuto3Dnr != 0;}

    public SprdCameraCapabilities(SprdCameraCapabilities src) {
        mSupportedAntibanding.addAll(src.mSupportedAntibanding);
        mSupportedColorEffects.addAll(src.mSupportedColorEffects);// SPRD:Add for color effect Bug
                                                                  // 474727
        ...
        mSupportedFaceAttributesEnable = src.mSupportedFaceAttributesEnable;
        mSupportedAntibandAutoEnable = src.mSupportedAntibandAutoEnable;
        mSupportFlashLevel = src.mSupportFlashLevel;
    }
    ...
    /*
     * SPRD: Bug 1045656 add for age gender race detect @{
     */
    public boolean mSupportedFaceAttributesEnable = false;
    public boolean mSupportedAgeEnable = false;
    public boolean mSupportedGenderEnable = false;
    public boolean mSupportedRaceEnable = false;
    public final boolean getSupportedFaceAttributesEnable(){
        return mSupportedFaceAttributesEnable;
    }
    public final boolean getSupportedAgeEnable(){
        return mSupportedAgeEnable;
    }
    public final boolean getSupportedGenderEnable(){
        return mSupportedGenderEnable;
    }
    public final boolean getSupportedRaceEnable(){
        return mSupportedRaceEnable;
    }
    /* @} */
    ...
    public boolean mSupportedLogoWatermark = false;
    public boolean mSupportedTimeWatermark = false;

    public final boolean getSupportAiScene() {
        return mSupportedAiScene;
    }
    public final boolean getSupportLogoWatermark() { return mSupportedLogoWatermark; }
    public final boolean getSupportTimeWatermark() { return mSupportedTimeWatermark; }
    public float[] mSprdZoomRatioSection = null;
    public final float[] getZoomRatioSection(){
